...
<section class="siteAbout">
    <p class="xl4-text-n">A collection of super good links from across the internet. This project brings together some of the best links on design, visual communciation, photography, digital culure and more, sharing articles, websites, tools and software to inform and inspire. Super~Goods is a completly open source project, from the code to the content, everything is freely availble online. Powered by Are.na, you can choose to follow the channel, fork a copy of the site and create your own super~good site. Super~Goods also has a newsletter, delivering the latest picks directly to your inbox. </p>
</section>
