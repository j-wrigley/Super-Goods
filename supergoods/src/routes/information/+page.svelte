...
<section class="siteAbout">
    <p class="xl4-text-n">A collection of super good links from across the internet. This project brings together some of the best links on design, visual communication, photography, digital culture and more, sharing articles, websites, tools and software to inform and inspire. Super~Goods is a completely open source project, from the code to the content, everything is freely available online. Powered by Are.na, you can choose to follow the channel, fork a copy of the site and create your own super good site to share your links and create your own version of this project, you can find the full code for this project over on GitHub. Super~Goods also has a newsletter, delivering the latest picks directly to your inbox, so if you prefer to keep updated that way, please consider joining.</p>
    <br>
